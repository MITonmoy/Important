...
export class TooltipService {
    ...
    createAttachment(target: any, element: any, position: any): Tether {
        let attachment;
    ...
    setTriggers(element: Element, triggers: any, listeners: any) {
    ...
    removeTriggers(element: any, triggers: any, listeners: any) {
        if (!triggers.includes('none')) {
            if (triggers.includes('mouseover')) {
